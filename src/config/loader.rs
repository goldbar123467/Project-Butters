...
pub struct StrategySection {
    ...
    /// Number of consecutive bars above z_threshold required for entry (sniper mode)
...
impl From<&Config> for crate::strategy::params::StrategyConfig {
    fn from(config: &Config) -> Self {
        ...
        StrategyConfig {
            ...
            consecutive_bars_required: config.strategy.consecutive_bars_required,
